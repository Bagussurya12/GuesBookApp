...
<div style="background-color: #6495ED; padding-top:15px; padding-bottom:15px;">
  <table width="100%" border="0">
    <tr>
      <td width="90%">
        <div style="align-items: center; text-align: center; color:white; font-weight: bold;" class="font">Online Guestbook App</div>
      </td>
      <td width="10%">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-2" >
          <a href="{{ route('user.buattamu') }}">
            <div class="callout callout-info text-center" style="background-color: #012a5f">
