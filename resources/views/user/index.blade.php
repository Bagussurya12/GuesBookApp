                    ...
                    <table id="example1" class="table table-striped table-valign-middle">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                              <button type="button" class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#modal-lg-edit{{ $dt->id }}">Ubah</button>
                              <button type="button" class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#modal-sm-hapus{{ $dt->id }}">Hapus</button>
                            </center>
                          </td>
