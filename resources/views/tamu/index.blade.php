                                          ...
                                          <div class="form-group row">
                                            <div class="col-sm-12">
                                              <select class="form-control select2bs4" id="pilihsumber" required name="sumber"  style="width: 100%;">
                                                ...
                                                <option value="Media Publikasi (Koran/Majalah/Radio/TV)" @if('Media Publikasi (Koran/Majalah/Radio/TV)' == $dt->sumber) selected="selected"@endif>Media Publikasi (Koran/Majalah/Radio/TV)</option>
                                                <option value="Social Media (IG/FB/Tik-Tok/Linkedin)" @if('Social Media (IG/FB/Tik-Tok/Linkedin)' == $dt->sumber) selected="selected"@endif>Social Media (IG/FB/Tik-Tok/Linkedin)</option>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <select class="form-control select2bs4" id="pilihsumber" required name="sumber"  style="width: 100%;">
                          ...
                          <option value="Media Publikasi (Koran/Majalah/Radio/TV)">Media Publikasi (Koran/Majalah/Radio/TV)</option>
                          <option value="Social Media (IG/FB/Tik-Tok/Linkedin)">Social Media (IG/FB/Tik-Tok/Linkedin)</option>
